...
const passcodeToUser = {
    '712': '1', '953': '2', '401': '3', '624': '4', '187': '5',
    '039': '6', '580': '7', '246': '8', '718': '9', '469': '10',
    '325': '11', '892': '12', '514': '13', '070': '14', '683': '15',
    '157': '16', '260': '17', '941': '18', '372': '19', '835': '20',
    '480': '21', '195': '22', '267': '23', '398': '24', '729': '25',
    '051': '26', '846': '27', '134': '28', '605': '29', '978': '30',
    '413': '31', '056': '32', '729': '33', '382': '34', '160': '35',
    '547': '36', '890': '37', '234': '38', '671': '39', '408': '40',
    '982': '41', '513': '42', '679': '43', '104': '44', '356': '45',
    '820': '46', '457': '47', '291': '48', '783': '49', '065': '50',
    '148': '51', '529': '52', '370': '53', '691': '54', '054': '55',
    '287': '56', '630': '57', '948': '58', '215': '59', '407': '60',
    '582': '61', '364': '62', '709': '63', '143': '64', '690': '65',
    '812': '66', '435': '67', '970': '68', '268': '69', '154': '70',
    '609': '71', '734': '72', '281': '73', '496': '74', '830': '75',
    '157': '76', '365': '77', '942': '78', '078': '79', '521': '80',
    '317': '81', '864': '82', '429': '83', '750': '84', '183': '85',
    '602': '86', '951': '87', '470': '88', '326': '89', '859': '90',
    '590': '91', '713': '92', '642': '93', '104': '94', '238': '95',
    '965': '96', '487': '97', '351': '98', '820': '99', '576': '100',
    '794': '101', '312': '102', '650': '103', '983': '104', '427': '105',
    '105': '106', '867': '107', '294': '108', '531': '109', '608': '110',
    '142': '111', '376': '112', '890': '113', '215': '114', '734': '115',
    '608': '116', '352': '117', '479': '118', '561': '119', '907': '120',
    '860': '121', '423': '122', '719': '123', '154': '124', '062': '125',
    '387': '126', '581': '127', '940': '128', '276': '129', '305': '130',
    '639': '131', '710': '132', '254': '133', '893': '134', '467': '135',
    '128': '136', '095': '137', '742': '138', '531': '139', '680': '140',
    '298': '141', '713': '142', '456': '143', '904': '144', '827': '145',
    '135': '146', '602': '147', '479': '148', '368': '149', '150': '150',
    '421': '151', '769': '152', '038': '153', '594': '154', '860': '155',
    '327': '156', '105': '157', '682': '158', '473': '159', '951': '160',
    '735': '161', '208': '162', '649': '163', '410': '164', '829': '165',
    '376': '166', '591': '167', '047': '168', '682': '169', '153': '170',
    '580': '171', '439': '172', '267': '173', '314': '174', '795': '175',
    '860': '176', '142': '177', '607': '178', '935': '179', '218': '180',
    '964': '181', '570': '182', '382': '183', '149': '184', '607': '185',
    '835': '186', '120': '187', '496': '188', '731': '189', '285': '190',
    '853': '191', '192': '192', '670': '193', '405': '194', '738': '195',
    '961': '196', '284': '197', '539': '198', '106': '199', '427': '200',
    'M514': '201'
};
...
app.post('/api/save-quiz-result', async (req, res) => {
    try {
        ...
        // Calculate tokens based on score (multiplied by 10)
        let tokensEarned = 0;
        if (score >= 8) {
            tokensEarned = 100;
        } else if (score >= 5) {
...
app.post('/api/admin/update-passkey', requireAuth, async (req, res) => {
    try {
        ...
        if (!/^[0-9]{3}$/.test(newPasscode)) {
            return res.status(400).json({
                success: false,
                error: 'Passcode must be exactly 3 digits'
            });
        }
        ...
        const existingUserId = passcodeToUser[passcode];
        ...
        passcodeToUser[passcode] = userId;

        console.log(`Admin updated passcode for user ${userId} to ${passcode}`);
